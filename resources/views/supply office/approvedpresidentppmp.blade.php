      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="approvedcsappmp" class="nav-link active">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="approvedceatppmp">CEAT</option>
                        <option value="approvedcbetppmp">CBET</option>
                        <option value="approvedcedppmp">CED</option>
                        <option value="approvedcasppmp">CAS</option>
                        <option value="approvedipeppmp">IPE</option>
                        <option value="approvedcsappmp">CSA</option>
                        <option value="approvedmicppmp">MIC</option>
                        <option value="approveddrrmoppmp">DRRMO</option>
                        <option value="approvedgcscppmp">GCSC</option>
                        <option value="approvedovpppmp">OVP</option>
                        <option value="approvedsgoppmp">SGO</option>
                        <option value="approvedsracppmp">SRAC</option>
                        <option value="approvedhrdcppmp">HRDC</option>
                        <option value="approvedsupplyppmp">Supply Office</option>
                        <option value="approvedfinanceppmp">Finance Office</option>
                        <option value="approvedpresidentppmp" selected="selected">Office of the President</option>
                        <option value="approvedbacppmp">BAC Office</option>
                      </select>
                    </div>
                  </div>
