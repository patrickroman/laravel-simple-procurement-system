                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="soppmpceat">CEAT</option>
                        <option value="soppmpcbet">CBET</option>
                        <option value="soppmpced">CED</option>
                        <option value="soppmpcas">CAS</option>
                        <option value="soppmpipe">IPE</option>
                        <option value="soppmpcsa">CSA</option>
                        <option value="soppmpmic">MIC</option>
                        <option value="soppmpdrrmo">DRRMO</option>
                        <option value="soppmpgcsc">GCSC</option>
                        <option value="soppmpovp">OVP</option>
                        <option value="soppmpsgo">SGO</option>
                        <option value="soppmpsrac">SRAC</option>
                        <option value="soppmphrdc">HRDC</option>
                        <option value="soppmpsupply">Supply Office</option>
                        <option value="soppmpfinance">Finance Office</option>
                        <option value="soppmppresident" selected="selected">Office of the President</option>
                        <option value="soppmpbac">BAC Office</option>
                      </select>
                    </div>
                    <div class="ml-3 p-2"><a href="checkpresidentproplan"><button class="btn btn-success btn-sm"><i class="fa fa-check-square"> Check Items</i></button></a></div>
                  </div>
