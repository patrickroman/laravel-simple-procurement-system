...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <!-- Main content -->
      <form role="form" id="form" action="presidentcheckupdate" method="post">
        @csrf
          ...
          <div class="card-body">
            <div class="card card-primary">
              ...
              <div class="card-footer bg-white d-flex">
                <a href="soppmppresident" class="btn btn-danger" role="button"><span aria-hidden="true" class="text-white">Close</span></a>
