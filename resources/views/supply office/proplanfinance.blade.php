...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <!-- Main content -->
      <form role="form" id="form" action="financecheckupdate" method="post">
        @csrf
          ...
          <div class="card-body">
            <div class="card card-primary">
              ...
              <div class="card-footer bg-white d-flex">
                <a href="soppmpfinance" class="btn btn-danger" role="button"><span aria-hidden="true" class="text-white">Close</span></a>
