                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        ...
                        <option value="soppmpfinance" selected="selected">Finance Office</option>
                        <option value="soppmppresident">Office of the President</option>
                        <option value="soppmpbac">BAC Office</option>
                      </select>
                    </div>
                    <div class="ml-3 p-2"><a href="checkfinanceproplan"><button class="btn btn-success btn-sm"><i class="fa fa-check-square"> Check Items</i></button></a></div>
                  </div>
