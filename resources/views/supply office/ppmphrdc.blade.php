                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        ...
                        <option value="soppmphrdc" selected="selected">HRDC</option>
                    ...
                    <div class="ml-3 p-2"><a href="checkhrdcproplan"><button class="btn btn-success btn-sm"><i class="fa fa-check-square"> Check Items</i></button></a></div>
                  </div>
