      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="sopreriv" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">PRE-REQUISITION AND ISSUE VOUCHER</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active">PRE-RIV</li>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">PRE-RIV / Edit PRE-RIV</h3>
                </div>

                <div class="card-body table-responsive">
                  <form role="form" id="form" action="editpreriv" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <table class="table table-striped table-bordered " id="item-list">
                          ...
                          <tbody>
                            ...
                            <tr class="po-item" data-id="">
                              <td class="align-middle p-1 text-center">
                                ...
                                <input type="hidden" id="department" name="department" value="{{ $requestview -> department }}">
                                <input type="checkbox" id="checkbox" name="checkbox[]" value="1">
                              </td>
                              <td class="align-middle p-0 text-center">
                                <input type="number" class="text-center w-100 border-0" step="any" name="qty[]" value="{{ $values -> quantity }}" max="{{ $values->quantity }}" min="1">
                                <input type="hidden" class="text-center w-100 border-0" step="any" name="prev_qty[]" value="{{ $values -> quantity }}">
                              </td>
                              <td class="align-middle p-1">
                                <input type="text" class="text-center w-100 border-0" name="unit[]" value="{{ $values -> unit }}" readonly>
                              </td>
                              <td class="align-middle p-1">
                                <input type="hidden" id="item_id" name="item_id[]" value="{{ $item_data[$index][0] -> ppmpID }}" />
                          ...
                          <tfoot>
                            ...
                            <tr>
                              ...
                              <th class="p-1 text-right" id="total">{{ number_format($requestview -> total_price,2 ) }}</th>
                            </tr>
                            </tr>
                          </tfoot>
                        </table>
                        ...
                        <div class="modal-footer justify-content-between">
                          <a href="sopreriv" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
