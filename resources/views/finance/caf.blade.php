            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex">
                  <h3 class="card-title p-2">CAF Table</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          <form action="cafview" method="get"><button class="btn btn-info btn-sm mr-1" type="submit" name="viewrequest" value="{{ $values -> request_id }}"><i class="fa fa-eye"></i></button></form>
                          <form action="cafedit" method="get"><button class="btn btn-primary btn-sm mr-1" type="submit" name="editrequest" value="{{ $values -> request_id }}"><i class="fa fa-edit"></i></button></form>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
