      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="foppmpcsa" class="nav-link active">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="foppmpceat">CEAT</option>
                        <option value="foppmpcbet">CBET</option>
                        <option value="foppmpced">CED</option>
                        <option value="foppmpcas">CAS</option>
                        <option value="foppmpipe">IPE</option>
                        <option value="foppmpcsa">CSA</option>
                        <option value="foppmpmic">MIC</option>
                        <option value="foppmpdrrmo">DRRMO</option>
                        <option value="foppmpgcsc">GCSC</option>
                        <option value="foppmpovp">OVP</option>
                        <option value="foppmpsgo">SGO</option>
                        <option value="foppmpsrac">SRAC</option>
                        <option value="foppmphrdc">HRDC</option>
                        <option value="foppmpsupply">Supply Office</option>
                        <option value="foppmpfinance">Finance Office</option>
                        <option value="foppmppresident" selected="selected">Office of the President</option>
                        <option value="foppmpbac">BAC Office</option>
                      </select>
                    </div>
                  </div>
