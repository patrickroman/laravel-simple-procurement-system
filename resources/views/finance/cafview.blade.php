      ...
      <section class="content">
        <div class="card card-outline card-info">
          <div class="card-header">
            <h3 class="card-title">CAF / View CAF</h3>
            <div class="card-tools">
              ...
              <a class="btn btn-sm btn-flat btn-default" href="focaf">Back</a>
            </div>
          </div>
          ...
          <div class="card-body table-responsive" id="out_print">
            ...
            <div class="col-12" style="margin-top: 5%; margin-bottom: 5%">
              <h2 class="text-center"><b>CERTIFICATE AS TO AVAILABILITY OF FUNDS</b></h2>
            </div>
