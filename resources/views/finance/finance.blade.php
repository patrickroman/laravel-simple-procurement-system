        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              <a href="fodashboard" class="nav-link active">
        ...
        <div class="container-fluid">
          ...
          <div class="d-flex justify-content-end mt-1 p-2" id="">
            <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
              <option value="financeDashboard,CSA" {{ $department == 'CSA' ? 'selected' : '' }}>CSA</option>
              <option value="financeDashboard,CBET" {{ $department == 'CBET' ? 'selected' : '' }}>CBET</option>
              <option value="financeDashboard,CED" {{ $department == 'CED' ? 'selected' : '' }}>CED</option>
              <option value="financeDashboard,CAS" {{ $department == 'CAS' ? 'selected' : '' }}>CAS</option>
              <option value="financeDashboard,IPE" {{ $department == 'IPE' ? 'selected' : '' }}>IPE</option>
              <option value="financeDashboard,CEAT" {{ $department == 'CEAT' ? 'selected' : '' }}>CEAT</option>
              <option value="financeDashboard,MIC" {{ $department == 'MIC' ? 'selected' : '' }}>MIC</option>
              <option value="financeDashboard,DRRMO" {{ $department == 'DRRMO' ? 'selected' : '' }}>DRRMO</option>
              <option value="financeDashboard,GCSC" {{ $department == 'GCSC' ? 'selected' : '' }}>GCSC</option>
              <option value="financeDashboard,OVP" {{ $department == 'OVP' ? 'selected' : '' }}>OVP</option>
              <option value="financeDashboard,SGO" {{ $department == 'SGO' ? 'selected' : '' }}>SGO</option>
              <option value="financeDashboard,SRAC" {{ $department == 'SRAC' ? 'selected' : '' }}>SRAC</option>
              <option value="financeDashboard,HRDC" {{ $department == 'HRDC' ? 'selected' : '' }}>HRDC</option>
              <option value="financeDashboard,Supply" {{ $department == 'Supply' ? 'selected' : '' }}>Supply Office</option>
              <option value="financeDashboard,Finance" {{ $department == 'Finance' ? 'selected' : '' }}>Finance Office</option>
              <option value="financeDashboard,President" {{ $department == 'President' ? 'selected' : '' }}>Office of the President</option>
              <option value="financeDashboard,BAC" {{ $department == 'BAC' ? 'selected' : '' }}>BAC Office</option>
            </select>
          </div>
