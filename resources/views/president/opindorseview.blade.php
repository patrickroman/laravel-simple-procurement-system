        ...
        <div class="card card-outline card-info">
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <a class="btn btn-sm btn-flat btn-default" href="opindorsement">Back</a>
            </div>
          </div>
          ...
          <div class="card-body table-responsive" id="out_print">
            ...
            <div class="col-12" style="margin-top: 5%; margin-bottom: 5%">
              <h2 class="text-center"><b>INDORSEMENT FROM OFFICE OF THE PRESIDENT</b></h2>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <label for="status" class="control-label">Action Taken: {{ $requestview -> action_taken }}</label>
                    <p></p>
                    <br>
                  </div>
                </div>
