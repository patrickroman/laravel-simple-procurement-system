...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="opdashboard" class="brand-link mt-2 mb-1">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Office of the President</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              <a href="opdashboard" class="nav-link active">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="opppmpcsa" class="nav-link">
                <i class="nav-icon fas fa-table"></i>
                <p>Procurement Plan</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="opindorsement" class="nav-link">
        ...
        <div class="container-fluid">
          ...
          <div class="d-flex justify-content-end mt-1 p-2" id="">
            <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
              <option value="presidentDashboard,CSA" {{ $department == 'CSA' ? 'selected' : '' }}>CSA</option>
              <option value="presidentDashboard,CBET" {{ $department == 'CBET' ? 'selected' : '' }}>CBET</option>
              <option value="presidentDashboard,CED" {{ $department == 'CED' ? 'selected' : '' }}>CED</option>
              <option value="presidentDashboard,CAS" {{ $department == 'CAS' ? 'selected' : '' }}>CAS</option>
              <option value="presidentDashboard,IPE" {{ $department == 'IPE' ? 'selected' : '' }}>IPE</option>
              <option value="presidentDashboard,CEAT" {{ $department == 'CEAT' ? 'selected' : '' }}>CEAT</option>
              <option value="presidentDashboard,MIC" {{ $department == 'MIC' ? 'selected' : '' }}>MIC</option>
              <option value="presidentDashboard,DRRMO" {{ $department == 'DRRMO' ? 'selected' : '' }}>DRRMO</option>
              <option value="presidentDashboard,GCSC" {{ $department == 'GCSC' ? 'selected' : '' }}>GCSC</option>
              <option value="presidentDashboard,OVP" {{ $department == 'OVP' ? 'selected' : '' }}>OVP</option>
              <option value="presidentDashboard,SGO" {{ $department == 'SGO' ? 'selected' : '' }}>SGO</option>
              <option value="presidentDashboard,SRAC" {{ $department == 'SRAC' ? 'selected' : '' }}>SRAC</option>
              <option value="presidentDashboard,HRDC" {{ $department == 'HRDC' ? 'selected' : '' }}>HRDC</option>
              <option value="presidentDashboard,Supply" {{ $department == 'Supply' ? 'selected' : '' }}>Supply Office</option>
              <option value="presidentDashboard,Finance" {{ $department == 'Finance' ? 'selected' : '' }}>Finance Office</option>
              <option value="presidentDashboard,President" {{ $department == 'President' ? 'selected' : '' }}>Office of the President</option>
              <option value="presidentDashboard,BAC" {{ $department == 'BAC' ? 'selected' : '' }}>BAC Office</option>
            </select>
          </div>
