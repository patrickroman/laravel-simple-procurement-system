                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          <form action="opindorseview" method="get"><button class="btn btn-info btn-sm mr-1" type="submit" name="viewrequest" value="{{ $values -> request_id }}"><i class="fa fa-eye"></i></button></form>
                          <form action="opindorseedit" method="get"><button class="btn btn-primary btn-sm mr-1" type="submit" name="editrequest" value="{{ $values -> request_id }}"><i class="fa fa-edit"></i></button></form>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
