        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="opdashboard" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="opppmpcsa" class="nav-link active">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="opppmpceat">CEAT</option>
                        <option value="opppmpcbet">CBET</option>
                        <option value="opppmpced">CED</option>
                        <option value="opppmpcas">CAS</option>
                        <option value="opppmpipe">IPE</option>
                        <option value="opppmpcsa" selected="selected">CSA</option>
                        <option value="opppmpmic">MIC</option>
                        <option value="opppmpdrrmo">DRRMO</option>
                        <option value="opppmpgcsc">GCSC</option>
                        <option value="opppmpovp">OVP</option>
                        <option value="opppmpsgo">SGO</option>
                        <option value="opppmpsrac">SRAC</option>
                        <option value="opppmphrdc">HRDC</option>
                        <option value="opppmpsupply">Supply Office</option>
                        <option value="opppmpfinance">Finance Office</option>
                        <option value="opppmppresident">Office of the President</option>
                        <option value="opppmpbac">BAC Office</option>
                      </select>
                    </div>
                  </div>
