...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="opdashboard.php" class="brand-link mt-2 mb-1">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="opindorsement" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Indorsement from Office of the President</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Indorsement / Edit Indorsement</h3>
                </div>

                <div class="card-body table-responsive">
                  <form role="form" action="opeditindorse" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <label for="notes" class="control-label">Category</label><br>
                            <div class="row">
                              <select class="form-control col-md-6" id="category" size="1" onchange="makeSubmenu(this.value)">
                                <option value="" disabled selected>Choose Category</option>
                                <option value="GOODS">Goods & Services</option>
                                <option value="INFRA">Infrastructure</option>
                              </select>
                              <select class="form-control col-md-6" name="category" id="categorySelect" size="1">
                        ...
                        <div class="modal-footer justify-content-between">
                          <a href="opindorsement" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
  ...
  <script>
    ...
    var subcategory = {
      GOODS: ["Small Value Procurement", "Shopping", "Canvas", "Bidding"],
      INFRA: ["Infrastructure Bidding"]
    }
