    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">GCSC Home Page</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item ">
              <a href="gcscdashboard" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="gcscproplan" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="gcscrequest" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Active Request</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="gcscrequest2" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closed Request</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview">
              <a href="gcsctrash" class="nav-link">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Purchase Request / Edit Request</h3>
                </div>

                <div class="card-body table-responsive">
                  <form role="form" action="gcsceditrequest" method="post">
                    @csrf
                      ...
                      <div class="col-md-12">
                          ...
                          <tbody>
                            ...
                            <tr class="po-item" data-id="">
                              <td class="align-middle p-1 text-center">
                                ...
                                <input type="hidden" name="Id" value="{{ $requestview[0] -> request_id }}">
                                <button class="btn btn-sm btn-danger py-0" type="button" onclick="rem_item($(this))"><i class="fa fa-times"></i></button>
                              </td>
                              <td class="align-middle p-0 text-center">
                                <input type="number" class="text-center w-100 border-0" step="any" id="qty" min="1" name="qty[]" value="{{ $values -> quantity }}">
                              </td>
                              <td class="align-middle p-1">
                                <input type="text" class="text-center w-100 border-0" name="unit[]" value="{{ $values -> unit }}" readonly>
                              </td>
                              <td class="align-middle p-1">
                                <input type="hidden" name="item_id[]" value="{{ $item_data[$index][0] -> ppmpID }}" />
                                <input type="text" class="text-center w-100 border-0 item_id" placeholder="Enter Item Name" value="{{ $item_data[$index][0] -> ItemDet }}" readonly />
                              </td>
                              <td class="align-middle p-1 item-description">
                                <input type="text" class="text-right w-100 border-0" name="unit_price[]" value="{{ $values -> unit_price }}" readonly>
                              </td>
                              <td class="align-middle p-1 text-right total-price">{{ number_format($values -> quantity * $values -> unit_price, 2) }}</td>
                            </tr>
                            @endforeach
                          </tbody>
                          <tfoot>
                            ...
                            <tr>
                              <th class="p-1 text-right" colspan="5"><span><button class="btn btn btn-sm btn-flat btn-primary py-0 mx-1" type="button" id="add_row">Add Row</button></span></th>
                              <th class="p-1 text-right" id="sub_total"></th>
                            </tr>
                            </tr>
                          </tfoot>
                        </table>
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <textarea name="notes" id="notes" cols="10" rows="4" class="form-control rounded-0">{{ $requestview[0] -> notes }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <textarea name="purpose" id="purpose" cols="6" rows="1" class="form-control rounded-0">{{ $requestview[0] -> purpose }}</textarea>
                          </div>
                          <div class="col-md-6">
                            <label for="notes" class="control-label">Budget Source</label>
                            <textarea name="source" id="source" cols="6" rows="1" class="form-control rounded-0">{{ $requestview[0] -> budget_source }}</textarea>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <label for="notes" class="control-label">Actoin Taken</label>
                            <textarea name="action" id="action" cols="6" rows="1" class="form-control rounded-0">{{ $requestview[0] -> action_taken }}</textarea>
                          </div>
                        </div>
                        <div class="modal-footer justify-content-between">
                          <a href="gcscrequest" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
                ...
                <table class="d-none table-responsive" id="item-clone">
                  <tr class="po-item" data-id="">
                    <td class="align-middle p-1 text-center">
                      <button class="btn btn-sm btn-danger py-0" type="button" onclick="rem_item($(this))"><i class="fa fa-times"></i></button>
                    </td>
                    ...
                    <td class="align-middle p-1">
                      <input type="text" step="any" class="text-right w-100 border-0" name="unit_price[]" />
                    </td>
