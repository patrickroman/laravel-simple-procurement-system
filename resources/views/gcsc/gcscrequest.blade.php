            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex">
                  ...
                  <div class="ml-auto p-1"><a href="gcscrequestadd"><button class="btn btn-success btn-sm"><i class="fa fa-plus"> Create New</i></button></a></div>
                </div>
                <!-- /.card-header -->
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          ...
                          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <form action="gcscdetails" method="get"><button class="dropdown-item btn btn-info btn-sm mb-1" type="submit" name="details" value="{{ $values -> request_id }}"><i class="fa fa-info-circle"> DETAILS</i></button></form>
                            <form action="gcscrequestview" method="get"><button class="dropdown-item btn btn-info btn-sm mb-1" type="submit" name="viewrequest" value="{{ $values -> request_id }}"><i class="fa fa-print"> PRINT</i></button></form>
                            @if ( $values -> request_status === 0)
                            <form action="gcscrequestedit" method="get"><button class="dropdown-item btn btn-primary btn-sm mb-1" type="submit" name="editrequest" value="{{ $values -> request_id }}"><i class="fa fa-edit"> EDIT</i></button></form>
                            @else
                            <form action="gcscrequestedit" method="get"><button class="dropdown-item btn btn-primary btn-sm mb-1" type="submit" name="editrequest" value="{{ $values -> request_id }}" disabled><i class="fa fa-edit"> EDIT</i></button></form>
                            @endif
                            <form action="gcscdeleterequest" method="get"><button class="dropdown-item btn btn-danger btn-sm mb-1" type="submit" name="deleterequest" value="{{ $values -> request_id }}"><i class="fa fa-times"> DELETE</i></button></form>
                          </div>
                        </td>
                      </tr>
                      @endforeach
