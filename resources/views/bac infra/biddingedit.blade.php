...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="biddings" class="nav-link active">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form role="form" action="biddingsupdate" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="modal-footer justify-content-between">
                          <a href="biddings" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
  ...
  <!-- daterangepicker -->
  <script src="{{ asset('/bower_components/admin-lte/plugins/moment/moment.min.') }}"></script>
