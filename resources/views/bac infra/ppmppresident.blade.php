        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="bacinfra" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="bacinfppmpcsa" class="nav-link active">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <div class="d-flex">
                    <h3 class="card-title p-2">Office of the President Project Procurement Management Plan</h3>
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="bacinfppmpceat">CEAT</option>
                        <option value="bacinfppmpcbet">CBET</option>
                        <option value="bacinfppmpced">CED</option>
                        <option value="bacinfppmpcas">CAS</option>
                        <option value="bacinfppmpipe">IPE</option>
                        <option value="bacinfppmpcsa">CSA</option>
                        <option value="bacinfppmpmic">MIC</option>
                        <option value="bacinfppmpdrrmo">DRRMO</option>
                        <option value="bacinfppmpgcsc">GCSC</option>
                        <option value="bacinfppmpovp">OVP</option>
                        <option value="bacinfppmpsgo">SGO</option>
                        <option value="bacinfppmpsrac">SRAC</option>
                        <option value="bacinfppmphrdc">HRDC</option>
                        <option value="bacinfppmpsupply">Supply Office</option>
                        <option value="bacinfppmpfinance">Finance Office</option>
                        <option value="bacinfppmppresident" selected="selected">Office of the President</option>
                        <option value="bacinfppmpbac">BAC Office</option>
                      </select>
                    </div>
                  </div>
