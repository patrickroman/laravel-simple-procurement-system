...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="bacinfra" class="brand-link mt-2 mb-1">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              <a href="bacinfra" class="nav-link active">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="bacinfppmpcsa" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="biddings" class="nav-link">
        ...
        <div class="container-fluid">
          ...
          <div class="d-flex justify-content-end mt-1 p-2" id="">
            <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
              <option value="bacinfraDashboard,CSA" {{ $department == 'CSA' ? 'selected' : '' }}>CSA</option>
              <option value="bacinfraDashboard,CBET" {{ $department == 'CBET' ? 'selected' : '' }}>CBET</option>
              <option value="bacinfraDashboard,CED" {{ $department == 'CED' ? 'selected' : '' }}>CED</option>
              <option value="bacinfraDashboard,CAS" {{ $department == 'CAS' ? 'selected' : '' }}>CAS</option>
              <option value="bacinfraDashboard,IPE" {{ $department == 'IPE' ? 'selected' : '' }}>IPE</option>
              <option value="bacinfraDashboard,CEAT" {{ $department == 'CEAT' ? 'selected' : '' }}>CEAT</option>
              <option value="bacinfraDashboard,MIC" {{ $department == 'MIC' ? 'selected' : '' }}>MIC</option>
              <option value="bacinfraDashboard,DRRMO" {{ $department == 'DRRMO' ? 'selected' : '' }}>DRRMO</option>
              <option value="bacinfraDashboard,GCSC" {{ $department == 'GCSC' ? 'selected' : '' }}>GCSC</option>
              <option value="bacinfraDashboard,OVP" {{ $department == 'OVP' ? 'selected' : '' }}>OVP</option>
              <option value="bacinfraDashboard,SGO" {{ $department == 'SGO' ? 'selected' : '' }}>SGO</option>
              <option value="bacinfraDashboard,SRAC" {{ $department == 'SRAC' ? 'selected' : '' }}>SRAC</option>
              <option value="bacinfraDashboard,HRDC" {{ $department == 'HRDC' ? 'selected' : '' }}>HRDC</option>
              <option value="bacinfraDashboard,Supply" {{ $department == 'Supply' ? 'selected' : '' }}>Supply Office</option>
              <option value="bacinfraDashboard,Finance" {{ $department == 'Finance' ? 'selected' : '' }}>Finance Office</option>
              <option value="bacinfraDashboard,President" {{ $department == 'President' ? 'selected' : '' }}>Office of the President</option>
              <option value="bacinfraDashboard,BAC" {{ $department == 'BAC' ? 'selected' : '' }}>BAC Office</option>
            </select>
          </div>
