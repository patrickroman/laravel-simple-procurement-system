            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <div class="d-flex">
                    <h3 class="card-title p-2">Supply Office Project Procurement Management Plan</h3>
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        ...
                        <option value="bacinfppmpsupply" selected="selected">Supply Office</option>
                        <option value="bacinfppmpfinance">Finance Office</option>
                        <option value="bacinfppmppresident">Office of the President</option>
