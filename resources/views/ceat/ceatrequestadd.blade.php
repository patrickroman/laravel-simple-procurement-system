      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="ceatproplan.php" class="nav-link">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <form role="form" action="ceataddrequest" method="post">
                    @csrf
                      ...
                      <div class="col-md-12">
                        <table class="table table-striped table-bordered " id="item-list">
                          ...
                          <tfoot>
                            ...
                            <tr>
                              ...
                              <input type="hidden" name="controlno" value="<?php echo "2022-10" . (sprintf("%'.04d", mt_rand(1, 9999))); ?>">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <textarea name="purpose" id="purpose" cols="6" rows="1" class="form-control rounded-0"></textarea>
                          </div>
                          <div class="col-md-6">
                            <label for="source" class="control-label">Budget Source</label>
                            <textarea name="source" id="source" cols="6" rows="1" class="form-control rounded-0"></textarea>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
