      ...
      <section class="content">
        <div class="card card-outline card-info">
          <div class="card-header">
            <h3 class="card-title">Purchase Request / View Request</h3>
            <div class="card-tools">
              <button onclick="window.print()" class="btn btn-primary-sm btn-flat btn-success" id="print" type="button"><i class="fa fa-print"></i> Print</button>
              <!-- <a class="btn btn-sm btn-flat btn-primary" href="">Edit</a> -->
              <a class="btn btn-sm btn-flat btn-default" href="ceatrequest">Back</a>
            </div>
          </div>
          ...
          <div class="card-body table-responsive" id="out_print">
            <div class="row">
              ...
              <div class="col-4 d-flex align-items-center">
                <div>
                  ...
                  <p class="m-0">Control No: {{ $requestview[0] -> control_no }}</p>
            ...
            <div class="col-12" style="margin-top: 5%; margin-bottom: 5%">
              <h2 class="text-center"><b>PRE-REQUISITION AND ISSUE VOUCHER</b></h2>
            </div>

            <div class="row">
              <div class="col-8 d-flex align-items-center">
                <div>
                  <p class="m-0">Department: {{ $requestview[0] -> department }}</p>
                </div>
              </div>
              <div class="col-4 d-flex align-items-center">
                <div>
                  <p class="m-0">Date : {{ $requestview[0] -> created_at }}</p>
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-striped table-bordered " id="item-list">
                  ...
                  <tbody>
                    ...
                    <tr class="po-item" data-id="">
                      ...
                      <td class="align-middle p-1 text-right">{{ number_format($values -> quantity * $values -> unit_price, 2) }}</td>
                    </tr>
                    @endforeach
                  </tbody>
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <th class="p-1 text-right" id="total">{{ number_format($requestview[0] -> total_price,2 ) }}</th>
                    </tr>
                    </tr>
                  </tfoot>
                </table>
                <div class="row">
                  <div class="col-6">
                    <label for="notes" class="control-label">Notes: Notes: {{ $requestview[0] -> notes }}</label>
                    <p></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6">
                    <label for="notes" class="control-label">Purpose/s: {{ $requestview[0] -> purpose }}</label>
                    <p></p>
                  </div>
                  <div class="col-6">
                    <label for="status" class="control-label">Budget Source: {{ $requestview[0] -> budget_source }}</label>
                    <p></p>
                    <br>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-6">
                    <label for="status" class="control-label">Actoin Taken: Actoin Taken: {{ $requestview[0] -> action_taken }}</label>
                    <p></p>
                    <br>
                  </div>
                </div>
