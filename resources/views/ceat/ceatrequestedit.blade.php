    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">CEAT Home Page</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item ">
              <a href="ceatdashboard" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="ceatproplan" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="ceatrequest" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Active Request</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="ceatrequest2" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closed Request</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview">
              <a href="ceattrash" class="nav-link ">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <form role="form" action="ceateditrequest" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <tbody>
                            ...
                            <tr class="po-item" data-id="">
                              ...
                              <td class="align-middle p-1">
                                <input type="text" class="text-center w-100 border-0" name="unit[]" value="{{ $values -> unit }}">
                              </td>
                              <td class="align-middle p-1">
                                <input type="hidden" name="item_id[]" value="{{ $item_data[$index][0] -> ppmpID }}" />
                                <input type="text" class="text-center w-100 border-0 item_id" placeholder="Enter Item Name" value="{{ $item_data[$index][0] -> ItemDet }}" required />
                              </td>
                              <td class="align-middle p-1 item-description">
                                <input type="text" class="text-right w-100 border-0" name="unit_price[]" value="{{ $values -> unit_price }}">
                              </td>
                        ...
                        <div class="modal-footer justify-content-between">
                          <a href="ceatrequest" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
