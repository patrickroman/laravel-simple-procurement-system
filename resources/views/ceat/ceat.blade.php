...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/bower_components/admin-lte/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              <a href="ceatdashboard" class="nav-link active">
          ...
          <div class="row">
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <a class="shortcut" href="ceatproplan">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <a class="shortcut" href="ceatrequest">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <a class="shortcut" href="ceatrequest2">
