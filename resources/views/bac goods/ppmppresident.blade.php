      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="bacgsppmpcsa" class="nav-link active">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="bacgsppmpceat">CEAT</option>
                        <option value="bacgsppmpcbet">CBET</option>
                        <option value="bacgsppmpced">CED</option>
                        <option value="bacgsppmpcas">CAS</option>
                        <option value="bacgsppmpipe">IPE</option>
                        <option value="bacgsppmpcsa">CSA</option>
                        <option value="bacppmpmic">MIC</option>
                        <option value="bacppmpdrrmo">DRRMO</option>
                        <option value="bacppmpgcsc">GCSC</option>
                        <option value="bacppmpovp">OVP</option>
                        <option value="bacppmpsgo">SGO</option>
                        <option value="bacppmpsrac">SRAC</option>
                        <option value="bacppmphrdc">HRDC</option>
                        <option value="bacppmpsupply">Supply Office</option>
                        <option value="bacppmpfinance">Finance Office</option>
                        <option value="bacppmppresident" selected="selected">Office of the President</option>
                        <option value="bacppmpbac">BAC Office</option>
                      </select>
                    </div>
                  </div>
