...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              <a href="ppmpceat" class="nav-link active"><i class="nav-icon fas fa-table"></i>
    ...
    <div class="content-wrapper">
      ...
      <form role="form" action="editceatitem" method="post">
        @csrf

        <div class="modal-content ml-4" style="width: 96%;">
          <div class="modal-header">
          </div>
          <div class="modal-body">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Edit Row for Procurement Plan</h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="Id" value="{{ $proplandata[0] -> ppmpID }}">
                      <label for="exampleInputEmail1">Item Details (Name) </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="newitemdetail" value="{{ $proplandata[0] -> ItemDet }}">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Unit Measurement</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="newunitmeasure" value="{{ $proplandata[0] -> UnitMeas }}">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Price Catalogue</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="newprice" placeholder="00.00" value="{{ $proplandata[0] -> Price }}">
                    </div>
                  </div>
                </div>
                <div class="row" align="center">
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Q1</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" name="newq1" value="{{ $proplandata[0] -> Q1 }}">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Q2</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" name="newq2" value="{{ $proplandata[0] -> Q2 }}">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Q3</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" name="newq3" value="{{ $proplandata[0] -> Q3 }}">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Q4</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" name="newq4" value="{{ $proplandata[0] -> Q4 }}">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-footer justify-content-between">
            <a href="ppmpceat" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
