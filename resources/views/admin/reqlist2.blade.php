          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="adminreqlist2" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closed Request</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Closed Request List</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <div class="card">
                <div class="card-header d-flex">
                    ...
                    <div class="ml-auto p-1">
                        <form action="summary" method="" class="d-inline"><button class="btn btn-success btn-sm"><i class="fa fa-file">  Summary Report</i></button></form>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          <form action="requesthistory2" method="get"><button class="btn btn-info btn-sm mr-1" type="submit" name="history" value="{{ $values -> request_id }}"><i class="fa fa-eye"></i></button></form>
                        </td>
                      </tr>
                      @endforeach
