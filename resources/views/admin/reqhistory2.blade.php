          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="adminreqlist" class="nav-link active">
            ...
            <div class="modal-body">
              <div class="card card-secondary">
                ...
                <div class="card-body table-responsive">
                  <div class="row mb-4">
                    <p class="col-6"><b>Control No: {{ $requesthistory -> control_no }}</b></p>
                    <p class="col-6"><b>Date Created: {{ $requesthistory -> created_at }}</b></p>
                  </div>
                  ...
                  <div class="row mb-4">
                    <p class="col-6"><b>No. of Items: {{ $requesthistory -> item_count }}</b></p>
                    <p class="col-6"><b>Total Amount: {{ number_format($requesthistory -> total_price, 2) }}</b></p>
                  </div>
                  ...
                  <div class="row mb-4">
                    <p class="col-6"><b>Total No. of Approved Item/s: {{ $requesthistory -> approved_item_count }}</b></p>
                    <p class="col-6"><b>Total Amount: {{ number_format($requesthistory -> approved_total_price, 2) }}</b></p>
                  </div>

                  <div class="row mb-4">
                    <p class="col-6"><b>Last Updated By: @foreach($user_data as $user_data) {{ $user_data -> Firstname}} @endforeach</b></p>
                    <p class="col-4"><b>Date Updated: {{ $requesthistory -> updated_at }}</b></p>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <p class="col-6"><b>Delivered To: {{ $requesthistory -> delivered_to }}</b></p>
                  </div>

                  <div class="row mb-4">
                    <p class="col-6"><b>Status:</b>
                      <?php
                      switch ($requesthistory->request_status) {
                        case '1':
                    ...
                    <p class="col-6"><b>Remarks: {{ $requesthistory -> remarks }}</b></p>
                  </div>
                </div>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <a href="adminreqlist2" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
            </div>
          </div>
        </div>
      </section>
