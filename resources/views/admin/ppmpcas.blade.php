                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        ...
                        <option value="ppmpcas" selected="selected">CAS</option>
                    ...
                    <div class="ml-3 p-2"><a href="casadd"><button class="btn btn-success btn-sm"><i class="fa fa-plus"> Add Item</i></button></a></div>
                  </div>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <div class="d-flex mt-2">
                              <form action="casedit" method="get"><button class="btn btn-primary btn-sm mr-1" type="submit" name="editproplan" value="{{ $proplandata -> ppmpID }}"><i class="fa fa-edit"></i></button></form>
                              <button class="btn btn-danger btn-sm" type="button" id="removeIDButton" value="{{ $proplandata -> ppmpID }}" data-toggle="modal" data-target="#modal-default"><i class="fa fa-times"></i></button></form>
                            </div>
                          </td>
                        </tr>
                        @endforeach
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <form action="casdelete" method="get"><button type="submit" name="removeid" id="removeIDInput" class="btn btn-danger">Delete</button></form>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
