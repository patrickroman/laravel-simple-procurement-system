        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="ppmpcsa" class="nav-link">
                <i class="nav-icon fas fa-table"></i>
                <p>Procurement Plan</p>
              </a>
            </li>
            <li class="nav-item has-treeview">
              <a href="approvedppmpcsa" class="nav-link active">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <div class="d-flex">
                    <h3 class="card-title p-2">Approved Office of the President Project Procurement Management Plan</h3>
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        <option value="approvedppmpceat">CEAT</option>
                        <option value="approvedppmpcbet">CBET</option>
                        <option value="approvedppmpced">CED</option>
                        <option value="approvedppmpcas">CAS</option>
                        <option value="approvedppmpipe">IPE</option>
                        <option value="approvedppmpcsa">CSA</option>
                        <option value="approvedppmpmic">MIC</option>
                        <option value="approvedppmpdrrmo">DRRMO</option>
                        <option value="approvedppmpgcsc">GCSC</option>
                        <option value="approvedppmpovp">OVP</option>
                        <option value="approvedppmpsgo">SGO</option>
                        <option value="approvedppmpsrac">SRAC</option>
                        <option value="approvedppmphrdc">HRDC</option>
                        <option value="approvedppmpsupply">Supply Office</option>
                        <option value="approvedppmpfinance">Finance Office</option>
                        <option value="approvedppmppresident" selected="selected">Office of the President</option>
                        <option value="approvedppmpbac">BAC Office</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table id="dtHorizontalVerticalExample" class="table table-bordered table-m " width="100%">
                      <thead>
                        <tr align="center">
                          <th>#</th>
                          <th>Item Code</th>
