        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="{{ route('logout')}}" class=" dropdown-item">
              <button class="btn btn-danger btn-sm btn-lg" name="logout" style="width:100%">Logout</button>
            </a>
            <div class="dropdown-divider"></div>
          </div>
        </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  <a class="shortcut" href="usermanagement">
                    <h3><i class="fa fa-users"></i> {{ $countUser }}</h3>
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <a class="shortcut" href="adminreqlist">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <a class="shortcut" href="adminreqlist2">
                    <h3><i class="fa fa-shopping-cart"></i> {{ $countClosed }} </h3>
          ...
          <div class="d-flex justify-content-end mt-1 p-2" id="">
            <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
              <option value="adminDashboard,CSA" {{ $department == 'CSA' ? 'selected' : '' }}>CSA</option>
              <option value="adminDashboard,CBET" {{ $department == 'CBET' ? 'selected' : '' }}>CBET</option>
              <option value="adminDashboard,CED" {{ $department == 'CED' ? 'selected' : '' }}>CED</option>
              <option value="adminDashboard,CAS" {{ $department == 'CAS' ? 'selected' : '' }}>CAS</option>
              <option value="adminDashboard,IPE" {{ $department == 'IPE' ? 'selected' : '' }}>IPE</option>
              <option value="adminDashboard,CEAT" {{ $department == 'CEAT' ? 'selected' : '' }}>CEAT</option>
              <option value="adminDashboard,MIC" {{ $department == 'MIC' ? 'selected' : '' }}>MIC</option>
              <option value="adminDashboard,DRRMO" {{ $department == 'DRRMO' ? 'selected' : '' }}>DRRMO</option>
              <option value="adminDashboard,GCSC" {{ $department == 'GCSC' ? 'selected' : '' }}>GCSC</option>
              <option value="adminDashboard,OVP" {{ $department == 'OVP' ? 'selected' : '' }}>OVP</option>
              <option value="adminDashboard,SGO" {{ $department == 'SGO' ? 'selected' : '' }}>SGO</option>
              <option value="adminDashboard,SRAC" {{ $department == 'SRAC' ? 'selected' : '' }}>SRAC</option>
              <option value="adminDashboard,HRDC" {{ $department == 'HRDC' ? 'selected' : '' }}>HRDC</option>
              <option value="adminDashboard,Supply" {{ $department == 'Supply' ? 'selected' : '' }}>Supply Office</option>
              <option value="adminDashboard,Finance" {{ $department == 'Finance' ? 'selected' : '' }}>Finance Office</option>
              <option value="adminDashboard,President" {{ $department == 'President' ? 'selected' : '' }}>Office of the President</option>
              <option value="adminDashboard,BAC" {{ $department == 'BAC' ? 'selected' : '' }}>BAC Office</option>
            </select>
          </div>
