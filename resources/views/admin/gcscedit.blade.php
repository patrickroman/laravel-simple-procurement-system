...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="dashboard.php" class="brand-link mt-2 mb-1">
    ...
    <div class="content-wrapper">
      ...
      <form role="form" action="editgcscitem" method="post">
        @csrf
        ...
        <div class="modal-content ml-4" style="width: 96%;">
          ...
          <div class="modal-footer justify-content-between">
            <a href="ppmpgcsc" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
