                  ...
                  <div class="d-flex">
                    ...
                    <div class="form-group ml-auto mt-1 p-1" id="parent">
                      <select class="js-example-basic-single" id="select2" style="width: 100%" onchange="ppmp(this.value)">
                        ...
                        <option value="ppmphrdc" selected="selected">HRDC</option>
                    ...
                    <div class="ml-3 p-2"><a href="hrdcadd"><button class="btn btn-success btn-sm"><i class="fa fa-plus"> Add Item</i></button></a></div>
                  </div>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <div class="d-flex mt-2">
                              <form action="hrdcedit" method="get"><button class="btn btn-primary btn-sm mr-1" type="submit" name="editproplan" value="{{ $proplandata -> ppmpID }}"><i class="fa fa-edit"></i></button></form>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <form action="hrdcdelete" method="get"><button type="submit" name="removeid" id="removeIDInput" class="btn btn-danger">Delete</button></form>
                              </div>
                            </div>
                            <!-- /.modal-content -->
                          </div>
    ...
    <div class="modal fade" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <form action="hrdcdelete" method="get"><button type="submit" name="removeid" value="{{ $proplandata -> ppmpID }}" class="btn btn-danger">Delete</button></form>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
