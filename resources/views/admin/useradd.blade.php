...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="addfirstname" name="addfirstname" placeholder="Enter ..." required>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="addlastname" name="addlastname" placeholder="Enter ..." required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="addemail" name="addemail" placeholder="Enter ..." required>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label for="adduserpass">Password</label>
                          <input type="password" class="form-control" id="adduserpass" name="adduserpass" placeholder="Enter ..." required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <select class="js-example-basic-single" id="select2" size="1" onchange="makeSubmenu(this.value)" style="width: 100%" name="addrole">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <select class="js-example-basic-single" id="categorySelect" size="1" style="width: 100%" name="adddepartment">
  ...
  <script>
    ...
    var subcategory = {
      ...
      Requestor: ["CAS", "CBET", "CEAT", "CED", "IPE", "CSA", "MIC", "DRRMO", "GCSC", "SGO", "SRAC", "HRDC", "OVP", "Supply Office", "Finance Office", "Office of the President", "BAC Office"]
    }
