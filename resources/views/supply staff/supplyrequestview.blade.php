    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Supply Home Page</a>
          </div>
        </div>
        ...
        <div class="card card-outline card-info">
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <a class="btn btn-sm btn-flat btn-default" href="supplyrequest">Back</a>
            </div>
          </div>
          ...
          <div class="card-body table-responsive" id="out_print">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="notes" class="control-label">Notes: {{ $requestview[0] -> notes }}</label>
                    <p></p>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <label for="status" class="control-label">Actoin Taken: {{ $requestview[0] -> action_taken }}</label>
                    <p></p>
                    <br>
                  </div>
                </div>
