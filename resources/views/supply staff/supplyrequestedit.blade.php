      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item ">
              <a href="supplydashboard" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="supplyproplan" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="supplyrequest" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Active Request</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="supplyrequest2" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closed Request</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview">
              <a href="supplytrash" class="nav-link ">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <form role="form" action="supplyeditrequest" method="post">
                    @csrf
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="modal-footer justify-content-between">
                          <a href="supplyrequest" class="btn btn-danger" role="button"><span aria-hidden="true">Close</span></a>
