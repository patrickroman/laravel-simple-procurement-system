          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="casrequest2" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closed Request</p>
                  </a>
                </li>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          <form action="casdetails2" method="get"><button class="btn btn-info btn-sm mr-1" type="submit" name="details" value="{{ $values -> request_id }}"><i class="fa fa-eye"></i></button></form>
                        </td>
                      </tr>
                      @endforeach
