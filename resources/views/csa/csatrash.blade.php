          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="csarequest" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              <a href="csatrash" class="nav-link active">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex">
                  ...
                  <div class="ml-auto p-1"><a href="csarestoreall"><button class="btn btn-success btn-sm"><i class="fa fa-retweet"> Restore All </i></button></a></div>
                  <div class="p-1"><a href="csaeraseall"><button class="btn btn-danger btn-sm"><i class="fa fa-trash"> Delete All</i></button></a></div>
                </div>
                <!-- /.card-header -->
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" class="d-flex">
                          <form action="csarestore" method="get"><button class="btn btn-success btn-sm mr-1" type="submit" name="restore" value="{{ $values -> request_id }}"><i class="fa fa-retweet"></i></button></form>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <form action="csaerase" method="get"><button type="submit" name="erase" id="removeIDInput" class="btn btn-danger">Delete</button></form>
          </div>
        </div>
      </div>
    </div>
