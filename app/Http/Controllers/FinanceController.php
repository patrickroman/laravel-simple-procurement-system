...
use App\Notifications\FinanceDenied;
use App\Notifications\FODeliverNotification;
...
class FinanceController extends Controller
{
    public function fodashboard()
    {
        ...
        return view('finance/finance', ['notifications' => $notifications], compact('username', 'itemJson', 'department'));
    }
    ...
    public function csaproplan()
    {
        ...
        return view('finance/ppmpcsa', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function casproplan()
    {
        ...
        return view('finance/ppmpcas', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function cbetproplan()
    {
        ...
        return view('finance/ppmpcbet', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function ceatproplan()
    {
        ...
        return view('finance/ppmpceat', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function cedproplan()
    {
        ...
        return view('finance/ppmpced', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function ipeproplan()
    {
        ...
        return view('finance/ppmpipe', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function micproplan()
    {
        ...
        return view('finance/ppmpmic', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function drrmoproplan()
    {
        ...
        return view('finance/ppmpdrrmo', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function gcscproplan()
    {
        ...
        return view('finance/ppmpgcsc', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function ovpproplan()
    {
        ...
        return view('finance/ppmpovp', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function sgoproplan()
    {
        ...
        return view('finance/ppmpsgo', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function sracproplan()
    {
        ...
        return view('finance/ppmpsrac', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function hrdcproplan()
    {
        ...
        return view('finance/ppmphrdc', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function supplyproplan()
    {
        ...
        return view('finance/ppmpsupply', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function financeproplan()
    {
        ...
        return view('finance/ppmpfinance', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function presidentproplan()
    {
        ...
        return view('finance/ppmppresident', ['proplandata' => $data], ['notifications' => $notifications]);
    }
    public function bacproplan()
    {
        ...
        return view('finance/ppmpbac', ['proplandata' => $data], ['notifications' => $notifications]);
    }

    public function focaf()
    {

        $data = DB::select('SELECT * FROM request WHERE deleted_at IS NULL AND request_status = 1 ');
        ...
        return view('finance/caf', compact('data', 'requestor_data'), ['notifications' => $notifications]);
    }

    public function cafview(Request $request)
    {
        ...
        return view('finance/cafview', ['requestview' => $req_data], compact('order_data', 'item_data', 'requestor_data', 'notifications'));
    }

    public function cafedit(Request $request)
    {
        ...
        return view('finance/cafedit', ['requestview' => $req_data], compact('order_data', 'item_data', 'notifications'));
    }

    public function editcaf(Request $request)
    {
        ...
        if ($req_status == 2) {
            ...
            $user->notify(new FinanceApproved());
            ...
            try {
                ...
                $mail->Body = 'Your Request was Approved by the Finance Office';
            ...
            $approver = AdminModel::where('Department', 'Office of the President')->first();
            $approverEmail = $approver->Email;
            $approver->notify(new FODeliverNotification());
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Request Approval';
                $mail->Body = 'A Request was Delivered by the Finance Office';
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Request Approval';
                $mail->Body = 'Your Request was Denied by the Finance Office';
        ...
        return redirect('focaf')->with('message', 'update');
    }
}
